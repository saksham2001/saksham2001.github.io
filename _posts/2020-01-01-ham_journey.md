...
<div class="caption">
    Left: Early morning practice roll with a flagger showing flag to the buggy driver, a follow car behind, and a radio operator acknowledging the the buggy's position. Right: A pusher giving their all during race day on Fruh Street.
</div>
...
<div class="caption">
    Some images of our rotator with Yagi antennas pointing towards the moon, with the iconic Hamerschlag Hall in the background.
</div>


In my first semester, I became a Teaching Assistant for the Introduction to Amateur Radio course (18-059) taught by Tom Zajdel (AA3TZ). During, the course I helped in organizing couple of fun activities including Yagi antenna building lab, and SSTV image recepection event, and a fox hunt on our field day. This semester I also got my general grade amateur radio license in the USA (Callsign: **KD3AXL**).
...
<div class="caption">
    Field day for the Introduction to Amateur Radio course (18-059) in Spring 2025.
</div>

I did some other interesting endevours like taking my buggy experience to a whole new level by volenteering as a track marshall for the [Pittsburgh Vintage Grand Prix](https://pvgp.org). I also helped in comms during the CMU [SCS Pretty Good Race](http://www.cs.cmu.edu/~PGR/).

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="assets/video/pvgp2025.mp4" class="img-fluid rounded z-depth-1" controls=true %}
    </div>
</div>
<div class="caption">
